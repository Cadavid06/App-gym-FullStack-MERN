          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full bg-zinc-700/50 text-white px-4 py-4 rounded-xl border border-zinc-600/50 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none transition-all duration-200"
              >
